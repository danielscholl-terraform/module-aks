...
| kubernetes\_version | Kubernetes Version (Default) - latest | `string` | n/a | yes |
| linux\_profile | linux profile admin user/key | <pre>object({<br>    admin_username = string<br>    ssh_key        = string<br>  })</pre> | n/a | yes |
