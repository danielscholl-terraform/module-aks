...
locals {
  ...
  identity_name = (var.user_assigned_identity_name == null ? "${local.name}-control-plane" : var.user_assigned_identity_name)
  ...
  validate_cluster_name = ((var.name == null && var.names == null) ?
